...
def testGenerator(test_path, num_image=30, target_size=(256, 256), flag_multi_class=False, as_gray=True):
    imaes = os.listdir(test_path)[:num_image]
    for i in imaes:
        # path = os.path.join(test_path, i)
        img = io.imread(os.path.join(test_path, "%s" % i), as_gray=as_gray)
        img = img / 255
...
def geneTrainNpy(image_path, mask_path, flag_multi_class=False, num_class=2, image_prefix="images", mask_prefix="mask",
